...
class SupabaseService:
    ...
    async def get_empresa_by_id(self, empresa_user_id: str) -> Optional[Dict[str, Any]]:
        url = f"{self.base_url}/rest/v1/empresa?user_id=eq.{empresa_user_id}&limit=1"
    ...
    async def registrar_cliente_se_nao_existir(self, empresa_id: int, telefone: str, nome: str) -> bool:
        """Upsert cliente em clientes_whatsapp"""
